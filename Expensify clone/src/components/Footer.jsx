...
const Footer = () => {
  return (
    <div className='w-full h-[150vh] bg-[#061b09]'>
        ...
        <div className='w-full h-40 flex flex-col p-8 gap-3 text-white opacity-90'>
            <p className='text-xs'>
...
<p className='text-xs'>Money transmission services are provided by our partners, which includes Expensify Payments LLC (NMLS ID: 2017010), pursuant to its licenses. See the Terms of Service for more information.
        ...
        <div className='w-full h-75 bg-black overflow-hidden py-8 pl-8 pr-8' >
