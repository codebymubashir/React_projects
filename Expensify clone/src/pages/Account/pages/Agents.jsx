    ...
    <>
      ...
      <div className=' w-110 p-6 ml-55 mt-25'>
        ...
        <div className='text-white  w-90 text-center'>
          ...
          <p className='text-sm text-[#a7b4a8] '>Stop manually doing stuff. Instruct an agent instead and save yourself lots of time. <span className='text-[#56a8f3]'>Learn more.</span> </p>
        </div>
      </div>
    </>
  )
