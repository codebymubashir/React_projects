  ...
  return (
     <>
          <div className="w-full h-screen bg-[#061b09]">
            <h1 className="frances text-white text-xl p-4">Report</h1>
            ...
            <div className="flex flex-col gap-3  w-[50%] mt-30 ml-80 text-center  h-auto p-10">
                ...
                <h2 className="text-white text-3xl text-center font-bold frances">No reports yet</h2>
                <p className="text-[#a7b4a8] text-center text-base">Create a report or take a test drive of Expensify to learn more.</p>
                <div className="flex flex-row gap-3  justify-center">
                    <button className="text-white font-bold p-3 rounded-4xl bg-[#1a3d32]">Taka a test drive</button>
                    <button className="text-white font-bold p-3 rounded-4xl bg-[#03d47c] ">Create reports</button>
                </div>
            </div>
          </div>
        </>
